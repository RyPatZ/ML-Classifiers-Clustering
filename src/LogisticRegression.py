...
def main():
    ...
    for ds_cnt, ds in enumerate(datasets):
        ...
        classfList4 = []
        classfList5 = []
        values=[.1,.5,1.0,2.0, 5.0]
        for v in range(len(values)):
            classf = LogisticRegression(C=values[v])
        ...
        title = setsNames[ds_cnt], "Logistic Regression"
        plt.title(title)
        FinalList=[classfList1,classfList2,classfList3,classfList4,classfList5]
        ...
        print("Logistic Regression of",setsNames[ds_cnt])
