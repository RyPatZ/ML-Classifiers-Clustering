...
def main():
    ...
    for ds_cnt, ds in enumerate(datasets):
        ...
        classfList3 = []
        classfList4 = []
        values=[1e-5, 1e-3,0.1, 10.0]
        for v in range(len(values)):
            classf = MLPClassifier(alpha=values[v],max_iter=1000)
        ...
        title = setsNames[ds_cnt],"MLPClassifier"
        plt.title(title)
        FinalList=[classfList1,classfList2,classfList3,classfList4]
        ...
        print("MLPClassifier of",setsNames[ds_cnt])
        print("The best average value of",setsNames[ds_cnt],"is" ,HighestAverage)
