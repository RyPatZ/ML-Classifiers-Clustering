...
def main():
    ...
    for ds_cnt, ds in enumerate(datasets):
        ...
        for count in range(10):
            classf = GradientBoostingClassifier(max_depth=values)
        ...
        title = setsNames[ds_cnt], "GradientBoostingClassifier"
        plt.title(title)
        ...
        for c, list in enumerate(FinalList):
            ...
            if average>HighestAverage:
                ...
                HighestAValue=c+1
        print("GradientBoostingClassifier for",setsNames[ds_cnt])
